...
import com.Nairaland.VPN.OneSignal.MyNotificationOpenedHandler;
import com.Nairaland.VPN.OneSignal.MyNotificationReceivedHandler;
...
public class MainApplication extends MultiDexApplication {
    ...
    public void initHydraSdk() {
        ...
        ClientInfo clientInfo = ClientInfo.newBuilder()
                ...
                .carrierId(prefs.getString(BuildConfig.STORED_CARRIER_ID_KEY, "cra_tochyvpn"))
                .build();
